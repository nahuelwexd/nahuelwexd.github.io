	...
	return (
		<div className="container mx-auto px-8 pt-16 pb-8 space-y-8">
			...
			<section className="space-y-6">
				...
				<Work
					title="Replay"
					subtitle="Explore and watch YouTube videos"
					url="https://github.com/nahuelwexd/Replay">

					<p>
						An <strong>open source <Link href="https://www.youtube.com">YouTube</Link> client</strong> for those concerned
						about their privacy and sick of heavy browsers like me! This is one of my longest projects, since I've used
						it a lot to learn, and therefore I've restarted it many times.
					</p>

					<p>
						It's currently being written in <strong><Link href="https://wiki.gnome.org/Projects/Vala">Vala</Link></strong>,
						an <strong>object-oriented programming language</strong> developed by <strong><Link href="https://www.gnome.org">
						GNOME</Link></strong> that transpiles to C and makes use of the <strong><Link
						href="https://developer.gnome.org/gobject/stable">GLib Object System</Link></strong> to create its classes
						and interfaces, and in <strong><Link href="https://www.gtk.org">GTK</Link></strong>, a toolkit developed by
						the same foundation that allows creating fantastic interfaces that are fast and, together with <strong><Link
						href="https://gnome.pages.gitlab.gnome.org/libhandy">Handy</Link></strong>, are totally <strong>mobile
						friendly</strong>.
					</p>
				...
				<Work
					title="Vadi"
					subtitle="Dependency injection utilities for Vala"
